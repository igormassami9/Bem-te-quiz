...
--
INSERT INTO `perguntas` (`id`, `pergunta`, `id_categorias`)
VALUES (
        1,
        'A floresta tropical amazônica, cobre boa parte do noroeste do Brasil e se estende até a Colômbia, o Peru e outros países da América do Sul.\r\n\r\nQual país abriga a maior parte da Floresta Amazônica?',
        1
    ),
    (
        2,
        'Verdadeiro ou falso: A Floresta Amazônica abriga aproximadamente 10% de todas as espécies conhecidas do planeta.',
        1
    ),
    (
        3,
        'Qual dos seguintes exploradores europeus é creditado por ter sido um dos primeiros a explorar a região da Floresta Amazônica durante o século XVI?',
        3
    );
-- --------------------------------------------------------
--
...
--
INSERT INTO `respostas` (`id`, `resposta`, `pergunta_id`, `correta`)
VALUES (1, 'Colômbia', 1, 0),
    (2, 'Brasil', 1, 1),
    (3, 'Peru', 1, 0),
    (4, 'Bolívia', 1, 0),
    (5, 'Verdadeiro', 2, 1),
...
VALUES (
        1,
        'john13miranda@gmail.com',
        'matakura',
        '$2y$10$Rari8977g445u3O.KjYd2emujTrEZTMOCrGB61FmYv.MU10BCjkna'
    ),
    (
        2,
        'teste123@gmail.com',
        'teste09',
        '$2y$10$FjmLvarI54FPvKpxg.NpHOvbzSfNwal7pAeGz8SOZTAD.j2d8zLtm'
    );
--
