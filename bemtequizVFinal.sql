...
--
-- Host: localhost:3306
-- Tempo de geração: 07/11/2023 às 00:29
...
--
-- Banco de dados: `id21479018_bemtequiz`
--
...
(105, 'O Brasil, por suas dimensões continentais, possui uma diversidade de domínios naturais. Dentre os principais, destaca-se o domínio Amazônico. Nesse sentido, é correto afirmar que são características físico-ambientais e econômicas do domínio Amazônico:', 4, 'Amazônico, o maior domínio natural brasileiro, é que sua incrível biodiversidade é um verdadeiro tesouro escondido na floresta. Estima-se que mais de 25% de todos os ingredientes farmacêuticos ativos usados em medicamentos modernos são originários de plantas encontradas na Amazônia. Essa vasta e misteriosa floresta tropical abriga uma infinidade de plantas com propriedades medicinais ainda não descobertas, destacando a importância da preservação desse ecossistema não apenas para a ciência, mas também para a saúde humana.');
...
CREATE TABLE `pontuacoes` (
  ...
  `modo_jogo` varchar(255) NOT NULL,
...
INSERT INTO `pontuacoes` (`id`, `user_id`, `modo_jogo`, `pontuacao`) VALUES
(1, 9, 'Clássico', 170),
(2, 5, 'Clássico', 10),
(3, 14, 'Clássico', 95),
(4, 19, 'Clássico', 85),
...
--
-- Estrutura para tabela `pontuacoes_tempo`
--

CREATE TABLE `pontuacoes_tempo` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `pontuacao` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `pontuacoes_tempo`
--

INSERT INTO `pontuacoes_tempo` (`id`, `user_id`, `pontuacao`, `tempo`, `modo_jogo`, `data_hora`) VALUES
(1, 5, 60, '00:18', 'Tempo', '2023-11-05 14:28:51');
...
INSERT INTO `profile` (`id`, `user_id`, `image_path`) VALUES
(1, 5, 'profile/5_CanGriffithbeconsideredtrueevil1.webp'),
(2, 9, 'profile/9_LeagueofLegends_SeasonStart2018_CLIMB_concepts.jpg'),
(3, 14, 'profile/14_a2c692515c1c53ceaf8f72837d91c891.jpg'),
(4, 20, 'profile/20_download.jpg');
...
(383, 'Vegetação com folhas grossas e pequenas / Relevo pouco ondulado / Matas de restingas', 105, 0),
(384, 'Maior domínio natural brasileiro / Solos pobres e de baixa fertilidade / Extração de essências medicinais', 105, 1),
(385, 'Clima tropical e umidade alta / Maior domínio natural brasileiro / Relevo extremamente ondulado', 105, 0),
(386, 'Queimadas sem controle / Cultivo de monoculturas / Clima seco e baixa umidade', 105, 0),
(387, 'Colômbia', NULL, 0),
(388, 'Brasil', NULL, 1),
(389, 'Peru', NULL, 0),
(390, 'Bolívia', NULL, 0),
(399, 'Carvalho', 8, 0),
(400, 'Carvalho-do-cerrado', 8, 0),
(401, 'Açaí', 8, 0),
(402, 'Castanha-do-pará', 8, 1),
(403, 'Colômbia', 1, 0),
(404, 'Brasil', 1, 1),
(405, 'Peru', 1, 0),
(406, 'Bolívia', 1, 0);
...
(5, 'MestreEnsinador123@gmail.com', 'MestreEnsinador', '$2y$10$ZG0GHKfcT6ey7New4nIPqurxBDaEbCpTW3HtAAp9l4/GyluVFOvhq'),
(9, 'MestreDestruidor123@gmail.com', 'Conta 01', '$2y$10$gSoZ/jB0DJfAzWBVNKbmVup00s7hBAjzq0UT/OQI9uG2v522zCK0a'),
(10, 'doguinhak7@gmail.com', 'douglas', '$2y$10$i1xUWeFI04a/mLWPqzYjIejGRaOLGNh88KPbx9b4fRZHZEFqnE5iK'),
(11, 'MestreDestruidor553@gmail.com', 'kira546', '$2y$10$Fy4esURi/73GFvlRRSgR1Oh9n3WiolCrdwsGqZd324Ql5h70Ud0im'),
(12, 'doguinhak7@gmail.com', 'douglas', '$2y$10$PriCxhsaCpPM6Dti1dVB5eHQ2cRjqY5bYoaemTtbP9eAnPYowC7my'),
(13, 'zarakikenpachi@gmail.com', 'zaraki', '$2y$10$DiRPhwDDrAWhiDBMI028NOPGq1ZrzKr7dO63YChm59nTh4ONS2tTW'),
(14, 'jhinzhao@gmail.com', 'Conta 02', '$2y$10$o/w9ibsR5/qMVjRNkdbyo.08D1kL4OJYIvcHaBZUQB7lBPvwaY.M.'),
(15, 'doguinhak7@gmail.com', 'douglas', '$2y$10$KW09dCbJGahzrtWxFDMyf.Cb6KiQTDfJJBOExSUZo0rI8fagXiJsW'),
(16, 'doguinhak7@gmail.com', 'douglas', '$2y$10$3RpvZaulZ0cNcDIZg4fJjeSXaA42gEqBu4pPaU6MT6siEuic3npSa'),
(17, 'doguinhak7@gmail.com', 'douglas123', '$2y$10$Lidb.LaAia/OOtnAYRhMueJ4u7bwNYZ.Pt2TCnTDWk80yLlwfV7/C'),
(18, 'nota10teste@gmail.com', 'Nota10', '$2y$10$nhu4GjuokINV1KM1Yf4oluyaX/O3MzEQo9i8jbzyo/NtsgCmvuDM6'),
(19, 'douglas@hotmail.com', 'douglas123', '$2y$10$CYUtPsCOTpOsWbOtNCWQg.fmg3.dL2FPsHmmtDmD3bq5kxbO8rBC.'),
(20, 'Professores01@gmail.com', 'Professores', '$2y$10$BzfLxc591BBG7xAdttSSqOruDZsrxljGoX3k.cr5WpPNP2Rlk6oYi');
...
--
-- Índices de tabela `pontuacoes_tempo`
--
ALTER TABLE `pontuacoes_tempo`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `pontuacoes_tempo`
--
ALTER TABLE `pontuacoes_tempo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
